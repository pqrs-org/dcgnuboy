...
/* low level interface */
int ndc_vmu_read (uint8 addr, uint16 blocknum, uint8 *buffer);
int ndc_vmu_write (uint8 addr, uint16 blocknum, uint8 *buffer);
int ndc_vmu_read_blocks (uint8 addr, uint16 firstblk, uint8 *buffer, uint8 blocks);
int ndc_vmu_write_blocks (uint8 addr, uint16 firstblk, uint8 *buffer, uint8 blocks);

int ndc_vmu_get_dirent (dirent_vmu *vmu, uint8 addr, const char *filename);
int ndc_vmu_getall_dirent (dirent_vmu *entries, int *num_entries, uint8 addr);

int ndc_vmu_check_free_blocks (uint8 *free_mem, uint8 addr);
...
int ndc_vmu_allocate_file (uint8 addr, const char *filename, uint8 blocks);
int ndc_vmu_remove_file(uint8 addr, const char *filename);


/* high level interface */
int ndc_vmu_save(uint8 *src, uint32 src_len, uint8 addr, 
                 const char *filename,
                 const char *desc_short,
                 const char *desc_long, 
                 const uint8 *icon);
int ndc_vmu_load(uint8 *dst, uint32 *dst_len, uint8 addr, const char *filename);
