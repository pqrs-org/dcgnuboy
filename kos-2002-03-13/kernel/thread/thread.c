...
CVSID("thread.c,v 1.7 2002/02/24 00:23:27 bardtx Exp");

/*

This module supports thread scheduling in KOS. The timer
interrupt is used to re-schedule the processor HZ times per second. 
