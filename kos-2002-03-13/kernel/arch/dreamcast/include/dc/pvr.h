/* KallistiOS ##version##
   ...
   pvr.h,v 1.16 2002/03/11 04:18:33 axlen Exp
...
typedef struct pvr_stats {
	...
	uint32		frame_count;		/* Number of frames rendered */
	float		frame_last_time;	/* Render length for the last frame in seconds */
