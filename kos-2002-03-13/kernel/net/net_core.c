...
CVSID("net_core.c,v 1.3 2002/02/16 06:54:18 bardtx Exp");
...
struct netif_list net_if_list = LIST_HEAD_INITIALIZER();

/* ARP cache */        
struct netarp_list net_arp_cache = LIST_HEAD_INITIALIZER();
