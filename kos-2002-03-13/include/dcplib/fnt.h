/*
     ...
     fnt.h,v 1.3 2002/02/11 04:45:19 peterhatch Exp
*/
...
public:
  ...
  */
  ...
  virtual bool isFixedPitch () const {}

  virtual void setWidth (float w) {}
  virtual void setGap (float g) {}

  virtual float getWidth () const {}
  virtual float getGap () const {}

  virtual bool hasGlyph (char c) {}
};
  ...
  void bind_texture (int filter_mode)
	{
	  ...
	  //ta_poly_hdr_txr (&poly, TA_TRANSLUCENT, TA_ARGB4444, tex_width, tex_height, texture, TA_BILINEAR_FILTER);
